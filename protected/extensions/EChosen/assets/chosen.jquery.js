  ...
  */  var $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    function Chosen(elmn) {
      ...
      this.default_text_default = this.form_field.multiple ? "Выберите несколько значений" : "Выберите значение";
      this.set_up_html();
    ...
    Chosen.prototype.no_results = function(terms) {
      var no_results_html;
      no_results_html = $('<li class="no-results">Ничего не найдено "<span></span>"</li>');
