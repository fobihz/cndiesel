  ...
  */  var Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    function Chosen(elmn) {
      ...
      this.default_text_default = this.form_field.multiple ? "Выберите значения" : "Выберите значение";
      this.set_up_html();
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      return this.no_results_temp = new Template('<li class="no-results">Ничего не найдено "<span>#{terms}</span>"</li>');
    };
