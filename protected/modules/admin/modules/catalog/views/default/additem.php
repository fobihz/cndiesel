...
?>
 <table class="bordered-list">
     ...
     <tr>
        <td align="right" ><b><?php echo $form->label($root,'root'); ?>:</b></td>
        <td><?php echo $form->dropdownList($root,'root',$root->descendantsData(),array('style'=>'width:200px;','class'=>'url')); ?>
        <span title="<?=Yii::t('qtip', '#7')?>" class="qtipm"  ><img src="/images/admin/help.png" height="16" alt="help"></span>
        <br>
        <?php echo $form->error($root,'root'); ?></td>
     </tr>
